    ...
    extends BasePeer
{
    ...
    protected static final String CLASSNAME_DEFAULT =
        "fr.iut2.tc4.projet.torque.Note";
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setNote(row.getValue(offset + 1).asInt());
            obj.setControleId(row.getValue(offset + 2).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinControle(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinControle(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinControle(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(NotePeer.CONTROLE_ID,
            ControlePeer.CONTROLE_ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            Note obj1 = (Note) NotePeer
             ...
             omClass = ControlePeer.getOMClass();
            Controle obj2 = (Controle) ControlePeer
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                Controle temp_obj2 = (Controle) temp_obj1.getControle();

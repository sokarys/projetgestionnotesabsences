...
public abstract class BaseEtudiant extends BaseObject
{
    ...
    public List getCourss(Criteria criteria) throws TorqueException
    {
        if (collCourss == null)
        {
            ...
            {
                criteria.add(CoursPeer.ETUDIANT_ID, getEtudiantId() );
    ...
    public List getNotes(Criteria criteria) throws TorqueException
    {
        if (collNotes == null)
        {
            ...
            {
                criteria.add(NotePeer.ETUDIANT_ID, getEtudiantId() );
    ...
    public Object getByPeerName(String name)
    {
        ...
        if (name.equals(EtudiantPeer.CLASSE_ID))
        {
            return new Integer(getClasseId());
        }
        return null;
        ...
        throws TorqueException, IllegalArgumentException
    {
      ...
      if (EtudiantPeer.CLASSE_ID.equals(name))
        {

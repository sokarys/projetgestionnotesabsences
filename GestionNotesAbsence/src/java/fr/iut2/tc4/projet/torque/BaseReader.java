 ...
 * extended all references should be to Reader
 */
public abstract class BaseReader extends BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1292348011746L;

    /** The Peer class */
    private static final ReaderPeer peer =
        new ReaderPeer();
     ...
     * Otherwise if this Reader has previously
     * been saved, it will retrieve related References from storage.
     * If this Reader is new, it will return
    ...
    public List getReferences(Criteria criteria) throws TorqueException
    {
        if (collReferences == null)
        {
            ...
            {
                criteria.add(ReferencePeer.READER_ID, getReaderId() );
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this Reader is new, it will return
     * an empty collection; or if this Reader has previously
     * been saved, it will retrieve related References from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Reader.
     */
    ...
    {
        if (name.equals(ReaderPeer.READER_ID))
        {
            return new Integer(getReaderId());
        }
        if (name.equals(ReaderPeer.NAME))
        {
            return getName();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (ReaderPeer.READER_ID.equals(name))
        {
            return setByName("ReaderId", value);
        }
      if (ReaderPeer.NAME.equals(name))
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    ReaderPeer.doInsert((Reader) this, con);
                    setNew(false);
                }
                else
                {
                    ReaderPeer.doUpdate((Reader) this, con);
                }
            }
    ...
    {
        setReaderId(Integer.parseInt(key));
    }
    ...
    {
        return SimpleKey.keyFor(getReaderId());
    }
     ...
     */
    public Reader copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public Reader copy(Connection con) throws TorqueException
    {
     ...
     */
    public Reader copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new Reader(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public Reader copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new Reader(), deepcopy, con);
    }
     ...
     */
    protected Reader copyInto(Reader copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected Reader copyInto(Reader copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected Reader copyInto(Reader copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected Reader copyInto(Reader copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setReaderId(readerId);
        copyObj.setName(name);

...
public abstract class BaseControle extends BaseObject
{
    ...
    public void setNoteId(int v) throws TorqueException
    {
        ...
        if (aNote != null && !(aNote.getNoteId() == v))
        {
            aNote = null;
        }
    ...
    /**
     * Declares an association between this object and a Note object
     *
     * @param v Note
     * @throws TorqueException
     */
    public void setNote(Note v) throws TorqueException
    {
        if (v == null)
        {
            setNoteId( 0);
    ...
    /**
     * Returns the associated Note object.
     * If it was not retrieved before, the object is retrieved from
     * the database
     *
     * @return the associated Note object
     * @throws TorqueException
     */
    public Note getNote()
        throws TorqueException
    {
        if (aNote == null && (this.noteId != 0))
        {
            aNote = NotePeer.retrieveByPK(SimpleKey.keyFor(this.noteId));
        }
        return aNote;
    }
     ...
     * @throws TorqueException
     */
    public Note getNote(Connection connection)
        throws TorqueException
    {
        if (aNote == null && (this.noteId != 0))
        {
            aNote = NotePeer.retrieveByPK(SimpleKey.keyFor(this.noteId), connection);
        }
        return aNote;
    }
     ...
     *
     */
    public void setNoteKey(ObjectKey key) throws TorqueException
    {
    ...
    public Object getByPeerName(String name)
    {
        ...
        if (name.equals(ControlePeer.NOTE_ID))
        {
            return new Integer(getNoteId());
        }
        return null;
        ...
        throws TorqueException, IllegalArgumentException
    {
      ...
      if (ControlePeer.NOTE_ID.equals(name))
        {
